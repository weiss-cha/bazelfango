AGENT_NAME                  =       "Bazelfango"
TEAM_NAME                   =       "Team name here"

    
# These are algorithm parameters. You need to change this
DELTA                       =      0.9              #   How much should the epsilon shift by in every game
LR                          =      0.1            #   This is the learning rate. High learning rate means faster learning"                     
...
TAKE_DAMAGE                 =      -1     
EARN_AMMO                   =      1.25
COLLIDE_WITH_WALLS          =      0.125
DAMAGE_ITSELF               =      -2        
NO_DESTRUCTION              =      -0.125               
NO_KILL                     =      -0.125            
PLACING_BOMBS_WITH_NO_AMMO  =      0
BOMB_IN_RANGE               =      -1
...
GUIDANCE                    =       0.623                         # 1 means the agent copies exactly as the coach. 0 means that the agent makes random moves Should be between 1 and 0
